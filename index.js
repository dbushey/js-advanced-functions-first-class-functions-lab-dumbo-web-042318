...
// !!! elements of the array are const reference to the functions, NOT FUNCTIONS' CALLS
...
const createFareMultiplier = function(int) { return function(value){ return int * value;
  }
};
